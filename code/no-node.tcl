...
TestSimpleRep instproc init {} {
    $self instvar ns_ ngeo nsg1 nsg2 tcp1 tcp2 f0 f1 f2 trace_rtt tcpvar tcptyp cwndfile seqfile
    ...
    set cwndfile "$tcptyp rtt client."
...
TestSimpleRep instproc record {} {
	$self instvar ns_ tcp1 tcp2 f0 f1 f2 trace_rtt
        #Set the time after which the procedure should be called again
        set time 1
        # current cwnd
        set bw0 [$tcp1 set rtt_]
	set bw1 [$tcp1 set t_seqno_]
	set curr_rtt [expr [$tcp1 set rtt_] * [$tcp1 set tcpTick_]]
